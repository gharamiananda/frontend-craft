      ...
      <div className="container flex h-14 items-center justify-between gap-12">
        ...
        <div className="flex items-center gap-5 lg:hidden">
          <button type="button"
            ...
            width={100}
            height={100}
            src="/hamburger.svg" alt="Menu" className="w-2.5 stroke-zinc-900 dark:stroke-white" />
          </button>
          <a aria-label="Home" href="/">
            <Image
            width={100}
            height={100}
             src="/logo.svg" alt="Protocol" className="h-6" />
          </a>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex gap-4">
            ...
            width={100}
            height={100}
                src="/search.svg" alt="Search" className="h-5 w-5" />
              </button>
            </div>
          </div>
        </div>
